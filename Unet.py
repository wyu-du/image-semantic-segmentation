...
checkpointer=ModelCheckpoint('model-20180206.h5', verbose=1, save_best_only=True)
results=model.fit(X_train, Y_train, validation_split=0.1, batch_size=16, epochs=10, callbacks=[earlystopper,checkpointer])

# predict on train, val and test
model=load_model('model-20180206.h5', custom_objects={'mean_iou': mean_iou})
...
sub.to_csv('submission-20180206.csv', index=False)